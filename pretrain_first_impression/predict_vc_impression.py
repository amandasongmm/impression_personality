...
def split_on_2k(layer_name='conv53'):
    start_t = time.time()
    ...
    feat_arr = np.load(feature_file_name)  # 2200 * 100352, for examplecu.
...
def pca_and_regression_on_2k(pca_keep_dim=200, layer_name='conv53'):
    start_t = time.time()
...
def retrieve_previous_model():
    model_save_dir = '/home/amanda/Documents/vgg_model/2k_feat'
    feat_layer_file_name = 'conv51.npy'
    pca_keep_dim = 150
    ...
    print('\nStart loading pca on 2k feature array...feat layer={}\n'.format(feat_layer_file_name))
    file_name = '/home/amanda/Documents/vgg_model/2k_feat/conv51_keep_150_ratio_095_pca_model.pkl'
